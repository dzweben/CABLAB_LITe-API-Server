...
def apply_conditional_formatting(service, spreadsheet_id, sheet_id, column_mapping, highlight_color):
    ...
    for follow_up_col, stsw2_col in column_mapping.items():
        # Compute column indices for Follow up.2
                            ...
                            "values": [
                                {
                                    ...
                                    "userEnteredValue": f'=VALUE(INDEX(INDIRECT("stsw2!{stsw2_col}$2:{stsw2_col}"), MATCH(A11, INDIRECT("stsw2!$A$2:$A"), 0))) = 2'
                                }
                            ],
                        },
                        "format": {
...
def main():
    ...
    sheet_id_follow_up = 1494057416  # GID of Follow up.2
    sheet_id_stsw1 = 377031866  # GID of stsw2
