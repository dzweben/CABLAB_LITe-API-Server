...
// egress reach Temple's REDCap API at all? fetch-data.mjs:5 claims
// "Temple REDCap blocks Vercel IPs"; the whole shape of the Vercel
...
export async function GET(req: NextRequest) {
  ...
  const url = process.env.REDCAP_API_URL || "https://cphapps.temple.edu/redcap/api/";
  const token = process.env.REDCAP_LITE_TOKEN || "";
