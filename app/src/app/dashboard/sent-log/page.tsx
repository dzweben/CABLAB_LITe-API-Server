            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                {rows.slice(0, 500).map((e, i) => (
                  <tr key={`${e.sendKey || e.id}-${i}`} className="border-b border-gray-100 hover:bg-gray-50 align-top">
                    ...
                    <td className="px-4 py-2.5 text-gray-800">{e.instrument}
                      {e.dryRun && <span className="ml-2 inline-flex px-1.5 py-0.5 rounded text-[10px] font-semibold bg-sky-100 text-sky-800">DRY</span>}
                    </td>
                    ...
                    <td className="px-4 py-2.5">
                      <span className={`inline-flex px-2 py-0.5 rounded text-[11px] font-semibold ${STATUS_STYLE[e.status] || "bg-gray-100 text-gray-600"}`}>
                        {e.status}
                      </span>
