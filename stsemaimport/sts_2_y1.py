...
google_output_csv = "google_sheet_data_v2.csv"
redcap_api_url = "https://cphapps.temple.edu/redcap/api/"
redcap_api_token = "6E4C4AEFF6A66B2AC62EFCB8BB9246D5"
redcap_report_id = 8166
redcap_output_csv = "redcap_report_data_v2.csv"
intersection_csv = "intersection_data_v2.csv"
...
def prepare_redcap_import(intersection_data):
    ...
    for _, row in intersection_data.iterrows():
        ...
        new_date = base_date + timedelta(days=10 * 30)  # Set to 10 months after the base date
        ...
        record = {
            "record_id": record_id,
            "redcap_event_name": "screen_time_2_y1_arm_1",  # Updated event name
            "screen_time_2_1_date": new_date,
            "screen_time_cycle_2": 1,  # Updated field name
            "screen_time_settings_2_complete": 2,  # Updated field name
        }
