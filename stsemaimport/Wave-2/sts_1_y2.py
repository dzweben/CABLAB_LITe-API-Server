...
google_output_csv = "google_sheet_data_sts_1_y2.csv"
...
redcap_output_csv = "redcap_report_data_sts_1_y2.csv"
intersection_csv = "intersection_data_sts_1_y2.csv"
...
def prepare_redcap_import(intersection_data):
    ...
    for _, row in intersection_data.iterrows():
        records.append({
            ...
            "redcap_event_name": "screen_time_y2_arm_1",
            "screen_time_1_1_date": row["date"],
